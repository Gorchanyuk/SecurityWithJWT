...
@DisplayName("Тестирование методов кортроллера AdminController")
public class AdminControllerTest {
    ...
    @Test
    @WithAnonymousUser
    @DisplayName("Тестирование получения доступа к '/admin' неаворизованным пользователем")
    ...
    @DisplayName("Тестирование получения доступа к '/admin' для различных ролей пользователей")
