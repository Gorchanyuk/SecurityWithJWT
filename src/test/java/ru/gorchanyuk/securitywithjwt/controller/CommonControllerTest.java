...
@DisplayName("Тестирование методов кортроллера CommonController")
public class CommonControllerTest {
    ...
    @Test
    @WithAnonymousUser
    @DisplayName("Тестирование получения доступа к '/common' неаворизованным пользователем")
    void testAdminWithAnonymousUser() {
        mockMvc.perform(get("/common")
    ...
    @DisplayName("Тестирование получения доступа к '/common' для различных ролей пользователей")
